...
- **BUS-004:** New or substantially revised RS-485 interfaces SHOULD start from the intentional THVD1410 refresh, subject to datasheet and system review. Issue #1220 establishes the tracked derivative migration intent under ABSIS_MIGRATION.md. This does not qualify the reference circuit or expand an unrelated task into redesign. Unconfirmed reference variants and mixed-generation limits remain Q-02.
