...
Owner-approved desired state from Q-03. Apply to new or changed harness work; the existing released cable drawing is not silently revised by this requirements change.
