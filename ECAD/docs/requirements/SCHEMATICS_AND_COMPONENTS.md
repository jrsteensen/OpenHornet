...
Component selection MUST follow MFG-013/014/016 in [MANUFACTURING.md](MANUFACTURING.md): all fitted SMD parts available for JLCPCB procurement/assembly, through-hole parts sourced from DigiKey or Mouser, and cost assessed alongside technical suitability. Record exact MPN and distributor/JLCPCB identifiers separately; an approved electrical equivalent still needs sourcing and assembly eligibility checks.
