...
- **QUAL-010:** At John Steensen’s sole discretion, a very minor change MAY be accepted as fully qualified without a new physical prototype. Record his explicit acceptance for the exact revision, the prior physical evidence being carried forward, the change impact analysis and why a new build is unnecessary. This is not a blanket exemption or authority granted to other PR mergers; do not claim a new prototype was built. Complete applicable CAD, electrical, manufacturing and release reviews separately. Regenerate and review changed manufacturing outputs as applicable. A change described as “silkscreen only” still requires polarity/identity and assembly-access review.
...
## Development merge versus qualification

A development hardware PR MAY merge after human review before a physical prototype is fully qualified. Its review record MUST disclose incomplete checks, known failures, remaining qualification work and responsible reviewers; manufacturing outputs MUST be labeled provisional where applicable. Merge is not permission to claim validated or release-qualified hardware, and it does not bypass prototype-order acceptance. Very minor changes may use QUAL-010 only at John Steensen’s sole discretion.
